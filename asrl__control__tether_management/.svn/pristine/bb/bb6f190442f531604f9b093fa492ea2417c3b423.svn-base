...
mu_friction = .15 #Friction coefficient / determines the reachable area
...
minTensionV_extra = .35 # [V] Determines how much higher the minimal tension is when the arm points to the side. This is used to prevent dead-arm angles on flat ground. 
