...
logging = TRexLabJackLogger("/tmp/trexLJLogs/lj_registar/" + globalConfigData.to_register_log_name_split_1)
...
class LJSensorRegistrar:
    def __init__(self):
        # Register for read
        registarService = rospy.Service(globalConfigData.to_register_topic_name_split_1, registerLJSensor,  #'/register_lj_sensor', registerLJSensor,
            self.registerSensor)
    ...
    def callLJSensors(self):
        ...
        while not rospy.is_shutdown():
            try:
                ...
                for key, value in self.sensorPublishers.iteritems():
                    #print "*PUB to : ", key
